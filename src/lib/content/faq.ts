...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Your personal data is soft-deleted when you join a team, not hard-deleted, so nothing is ever permanently destroyed in that process.",
  },
  {
